            ...
            <Document>
                <Page size="A4">
                    ...
                    adiante designada como Mediadora,</p>
                        ...
                        <p>Cláusula {clausula()}ª</p>
                        <p>(Identificação do Imóvel)</p>
                        <p>
                    ...
                    e válido até ${props.validadeCertificadoEnergetico}.`}
                        ...
                        <p>Cláusula {clausula()}</p>
                        <p>(Identificação do Negócio)</p>
                        <p>
                            {
                        ...
                        <p>(Ónus e Encargos)</p>
                        {
                            props.onusImovel === 'nao' ?
                                <p>O imóvel encontra-se livre de quaisquer ónus ou encargos.</p>
                                :
                                <p>
                        ...
                        <p>1.	O Segundo Contratante contrata a Mediadora em regime de
                    {
                    ...
                    não sendo essa quantia inferior a €5.000,00 (cinco mil Euros) acrescido de IVA à taxa legal em vigor.`}
                        </p>
                        {
                            props.timingPagamentoRemuneração === 'sim' ?
                                <p>o total da remuneração aquando da celebração do contrato promessa.</p>
                                :
                                <p>
                                    {`${props.pagamentoCPCVPercentagem}% após a celebração do contrato promessa e o remanescente ${segundaRemuneracao()}%`}
                                </p>
                        }
                        <p>4.	Os intervenientes no presente contrato de mediação imobiliária abstêm-se de celebrar ou de algum modo participar em quaisquer negócios de que resulte a ¬violação dos limites à utilização de numerário previstos no artigo 63.º-E da Lei Geral Tributária,
                        ...
                        <p>Cláusula {clausula()}ª</p>
                        <p>(Garantias da Actividade de Mediação)</p>
                        <p>
                        ...
                        <p>Cláusula {clausula()}ª</p>
                        <p>(Prazo de Duração do Contrato)</p>
                        <p>
                        ...
                        <p>Cláusula {clausula()}ª</p>
                        <p>(Foro Competente e Resolução Alternativa de Litígios)</p>
                        {
                        ...
                        <p>Linda-a-Velha,{props.dataContrato}</p>
                    </div>
                </Page>

            </Document>
            <div className='Post' size="A4" ref={ref}>
